...
@section('content')
    ...
    <x-ui.card class="dash-filter-card" title="Filters">
        <form method="GET" action="{{ route('patient.appointments.index') }}" class="filter-grid">
            <x-form.input
                name="search"
    ...
    <x-ui.table
        :headers="['Date', 'Doctor', 'Specialization', 'Type', 'Status', 'Actions']"
            ...
            <tr>
                ...
                <td>
                    <div class="ui-actions">
                        <a class="ui-action-btn ui-action-btn--soft ui-action-btn--sm" href="{{ route('patient.appointments.info', $appointment) }}">
