...
@section('title', 'Update Hospital Doctor')

@section('content')
    <h2 class="dash-title">Update Doctor · {{ $hospital->name }}</h2>

    <x-ui.card title="Doctor Information" class="dash-filter-card">
        <form method="POST" action="{{ route('admin.hospitals.doctors.update.submit', [$hospital, $doctor]) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="ui-actions">
                ...
                <a class="ui-action-btn ui-action-btn--ghost" href="{{ route('admin.hospitals.doctors.info', [$hospital, $doctor]) }}">
