...
@section('content')
    ...
    <x-ui.card class="dash-filter-card" title="Filters">
        <form method="GET" action="{{ route('hospital-admin.appointments.index') }}" class="filter-grid">
            <x-form.input
                name="search"
                label="Search by patient/doctor"
                :value="request('search')"
                placeholder="patient email or doctor name"
            />
    ...
    <x-ui.table
        :headers="['Date', 'Patient', 'Doctor', 'Type', 'Status', 'Actions']"
            ...
            <tr>
                ...
                <td>
                    <div class="ui-actions">
                        <a class="ui-action-btn ui-action-btn--soft ui-action-btn--sm" href="{{ route('hospital-admin.appointments.info', $appointment) }}">
                        ...
                        <a class="ui-action-btn ui-action-btn--primary ui-action-btn--sm" href="{{ route('hospital-admin.appointments.update', $appointment) }}">
