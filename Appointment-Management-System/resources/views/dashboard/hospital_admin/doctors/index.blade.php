...
@section('content')
    <h2 class="dash-title">Doctors</h2>

    <div class="ui-actions" style="margin-bottom: 14px;">
        <a class="ui-action-btn ui-action-btn--primary" href="{{ route('hospital-admin.doctors.create') }}">
    ...
    <x-ui.card class="dash-filter-card" title="Filters">
        <form method="GET" action="{{ route('hospital-admin.doctors.index') }}" class="filter-grid">
            <x-form.input
                name="search"
            ...
            <tr>
                ...
                <td>
                    <div class="ui-actions">
                        <a class="ui-action-btn ui-action-btn--soft ui-action-btn--sm" href="{{ route('hospital-admin.doctors.info', $doctor) }}">
                        ...
                        <a class="ui-action-btn ui-action-btn--primary ui-action-btn--sm" href="{{ route('hospital-admin.doctors.update', $doctor) }}">
                        ...
                        <a class="ui-action-btn ui-action-btn--soft ui-action-btn--sm" href="{{ route('hospital-admin.doctors.availability.index', $doctor) }}">
