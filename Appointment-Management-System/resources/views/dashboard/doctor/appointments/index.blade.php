...
@section('content')
    ...
    <x-ui.card class="dash-filter-card" title="Filters">
        <form method="GET" action="{{ route('doctor.appointments.index') }}" class="filter-grid">
            <x-form.input
                name="search"
            ...
            <tr>
                ...
                <td>
                    <div class="ui-actions">
                        <a class="ui-action-btn ui-action-btn--soft ui-action-btn--sm" href="{{ route('doctor.appointments.info', $appointment) }}">
