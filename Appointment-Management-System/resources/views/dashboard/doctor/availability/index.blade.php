...
@section('content')
    <h2 class="dash-title">Availability</h2>

    <div class="ui-actions" style="margin-bottom: 14px;">
        <a class="ui-action-btn ui-action-btn--primary" href="{{ route('doctor.availability.create') }}">
            ...
            <tr>
                ...
                <td>
                    <div class="ui-actions">
                        <a class="ui-action-btn ui-action-btn--primary ui-action-btn--sm" href="{{ route('doctor.availability.update', $slot) }}">
                        ...
                        <form method="POST" action="{{ route('doctor.availability.delete', $slot) }}" onsubmit="return confirm('Delete this availability slot?')">
                            @csrf
