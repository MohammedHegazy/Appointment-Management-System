        ...
        <aside class="dash-sidebar">
            ...
            <nav class="dash-nav">
                <a href="{{ route('admin.index') }}"
                    class="dash-nav__item @if (request()->routeIs('admin.index')) is-active @endif">
                ...
                <a href="{{ route('admin.audit-logs.index') }}"
                    class="dash-nav__item @if (request()->routeIs('admin.audit-logs.*')) is-active @endif">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                        <path
                            d="M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zM7 7h10v2H7V7zm0 4h10v2H7v-2zm0 4h7v2H7v-2z" />
                    </svg>
                    <span>Audit Logs</span>
                </a>
                <a href="{{ route('admin.hospitals.index') }}"
                    class="dash-nav__item @if (request()->routeIs('admin.hospitals.*')) is-active @endif">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="{{ route('admin.doctors.index') }}"
                    class="dash-nav__item @if (request()->routeIs('admin.doctors.*')) is-active @endif">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="{{ route('admin.patients.index') }}"
                    class="dash-nav__item @if (request()->routeIs('admin.patients.*')) is-active @endif">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="{{ route('admin.settings.profile') }}"
                    class="dash-nav__item @if (request()->routeIs('admin.settings.*')) is-active @endif">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div class="dash-main">
            <header class="dash-topbar">
                ...
                <div class="dash-user-chip">
                    ...
                    <p class="dash-topbar__meta">Signed in as {{ $sidebarUser->first_name ?? 'Admin' }}</p>
                </div>
            </header>
