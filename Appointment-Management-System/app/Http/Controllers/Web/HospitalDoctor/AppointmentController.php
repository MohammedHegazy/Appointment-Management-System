...
class AppointmentController extends BaseHospitalDoctorController
{
    ...
    {
        $doctorId = (int) ($this->ensureHospitalDoctor()->doctor?->id ?? 0);
        ...
        return view('dashboard.hospital_doctor.appointments.index', [
    ...
    public function show(Appointment $appointment): View
    {
        ...
        return view('dashboard.hospital_doctor.appointments.info', [
    ...
    public function update(Request $request, Appointment $appointment): RedirectResponse
    {
        ...
        DB::transaction(function () use ($appointment, $validated, $request): void {
            ...
            if ($hasMedicalPayload) {
                ...
                $this->auditLogService->log(
                    action: 'hospital_doctor.medical_record_updated.web',
                    entity: $record,
            ...
            $this->auditLogService->log(
                action: 'hospital_doctor.appointment_updated.web',
                entity: $appointment,
        ...
        return redirect()
            ->route('hospital-doctor.appointments.info', $appointment)
    ...
    private function resolveAppointment(Appointment $appointment): Appointment
    {
        ...
        abort_unless($doctorId > 0, 404, 'Doctor profile not found.');
        abort_unless($user->hospital_id !== null, 403);
